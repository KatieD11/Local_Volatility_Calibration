...
hold on
plot(ks, spx_df.putBid_BSvol(filter), '*', 'MarkerSize', 3, 'MarkerFaceColor', '#0072BD', 'Color', '#0072BD');
hold on
plot(ks, spx_df.putAsk_BSvol(filter), '*', 'MarkerSize', 3, 'MarkerFaceColor', '#A2142F', 'Color', '#A2142F');
hold on
...
% end
legend(["Call bid", "Call ask", "Put bid", "Put ask", "Target"])
